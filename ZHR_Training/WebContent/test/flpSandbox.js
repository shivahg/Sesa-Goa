		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ZHRTrainingproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ZHRTrainingproject1-display": {
								"semanticObject": "ZHRTrainingproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ZHRTraining.project1",
									"url": sap.ui.require.toUrl("ZHRTraining/project1")
								}
							}
						}
					}
